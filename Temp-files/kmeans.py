...
def pre_process(df):
	...
	kmeans = MiniBatchKMeans(n_clusters=2,init = 'k-means++',random_state=0,batch_size=1000,verbose = 1,max_iter = 1000).partial_fit(X_train_tfidf)
...
# KMeans from sklearn documentation.
